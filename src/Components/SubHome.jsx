      ...
      {DataBase.map((item) => (
        <div className="w-full   justify-center flex">
          <div className="flex flex-col">
            <h1 className="text-white flex justify-center tracking-wider font-4 pb-5 pt-5 md:pt-10 md:pb-5">
              {item.title}
            </h1>
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="flex justify-center w-[350px] items-center bg-white/5 md:bg-transparent lg:border border-white/5 py-40 mb-20  rounded-b-2xl md:rounded-r-2xl md:rounded-l-none h-[280px] lg:h-[450px] px-7">
                <div className="  flex-col">
                  ...
                  <p className="text-white w-[268px] font-extralight text-sm lg:text-lg lg:w-[500px] pb- pb-20 md:px-10 ">
                    {item.description}
                  </p>
                </div>
              </div>
